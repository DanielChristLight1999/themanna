      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <h1 className="mt-6 text-3xl font-bold tracking-tight text-slate-900">Welcome, Affiliate</h1>
            <p className="mt-2 text-sm text-slate-600">Signup to create your affiliate account</p>
          </div>
