...
export function PaymentSettings({ initialSettings, permissions }: { initialSettings?: PaymentSettingsType, permissions: RolePermissionSettings }) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between">
                  ...
                  <FormControl>
                    <Switch checked={field.value} onCheckedChange={field.onChange} disabled={!canUpdateSettings} />
                  </FormControl>
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between">
                  ...
                  <FormControl>
                    <Switch disabled={!canUpdateSettings} checked={field.value} onCheckedChange={field.onChange} />
                  </FormControl>
                </FormItem>
              )}
            />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input disabled={!canUpdateSettings} type="number" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
